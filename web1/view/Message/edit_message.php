...
<head>
    ...
    <title>Edit Message | CultureHub</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Edit Message</h1>
        <form id="editMessageForm" action="index.php?route=message/update/<?= $message['id'] ?>" method="POST" class="shadow p-4 rounded bg-light">
            <!-- Blog ID -->
            <div class="form-group">
                <label for="blog_id">Blog ID:</label>
                <input type="number" id="blog_id" name="blog_id" value="<?= htmlspecialchars($message['blog_id']) ?>" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="author" name="author" value="<?= htmlspecialchars($message['author']) ?>" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <textarea id="message" name="message" rows="5" class="form-control" required><?= htmlspecialchars($message['message']) ?></textarea>
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" class="form-select" required>
                    <option value="Draft" <?= $message['status'] === 'Draft' ? 'selected' : '' ?>>Draft</option>
                    <option value="Published" <?= $message['status'] === 'Published' ? 'selected' : '' ?>>Published</option>
                </select>
